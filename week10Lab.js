...
myForm.style.backgroundColor = 'rgb(201, 300, 77)';
 ...
 * ↓ YOUR CODE HERE ↓ */
   ...
   myTable.style.border = '2px solid grey';
...
//Answer: With JavaScript you have more liberty with adding elements to your code compared to HTML which is static and can't be altered once it's been declared.
...
myButton.addEventListener('click', function (){
   document.body.style.backgroundColor = `rgb(${Math.random() * 0}, ${Math.random() * 125}, ${Math.random() * 255})`
});

//Question: What other event listeners are there?
//             Try them out by replacing 'click' in your function above!
//Answer: 'mousedown', 'mouseover', 'mouseout', 'mousemove'
