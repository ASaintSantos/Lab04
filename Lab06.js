...
for (let i = 0; i < array1[0]; i++) {
       console.log(array1);
       let removedElement = array1.splice(2, 1);                                                                   
...
for (let i = 0; i < array1[0]; i++) {
       console.log(array1);
       let removedElement = array1.splice(5, 1);                                                                   
   console.log(removedElement); 
   }
...
for (let i = 0; i < array1[0]; i++) {
       console.log(array1);
       let removedElement = array1.splice(7, 1);                                                                   
   console.log(removedElement); 
   }

//    yes it did change from earlier. I was able to get 16 with a splice method.
 ...
 * ↓ YOUR CODE HERE ↓ */
// Step 1:,Step 2:
var myTodoList = ['Clean', 'Study', 'Sleep'];
...
var yourTodoList = ['Work','Wash'];

console.log(yourTodoList);

// Step 5:

const myTodoList = ['Clean', 'Study', 'Sleep'];
const yourTodoList = ['Work','Wash'];
