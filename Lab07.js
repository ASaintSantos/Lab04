...
const eatAndDrink = "Pizza and Soda";
console.log(eatAndDrink);

let ourNames = `Azario and Jacinto.`;
console.log(ourNames);

//Question: Name a reason why you would use const instead of let.
//Answer: When using a const value the outcome wont change but stay constant. The let value allows the outcome to change.
...
let eatingAndDrinking = `Me and my friend are eating and drinking pizza and soda.`
console.log(eatingAndDrinking);
...
//Answer:  
const firstString = "Me and my friend are";
const secondString = "eating and drinking pizza and soda.";
...
let eatingAndDrinkingWater = `Me and my friend are eating and drinking pizza and water.`
console.log(eatingAndDrinkingWater);

//Question: Read the error message - in your own words - what does it mean?
//Answer: The error came from the string and making changes within it. but using the same string it caused an error. Had to make changes to the string name.
